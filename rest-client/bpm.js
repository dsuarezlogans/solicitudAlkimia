(function() {
  ...
  const baseUrl =
    'ec2-35-160-211-48.us-west-2.compute.amazonaws.com:8080/business-central';
  ...
  exports.señalInstancia = (req, res) => {
    ...
    const urlSignal =
      ...
      ':' +
      req.params.pass +
      `@${baseUrl}/rest/runtime/com.originacionCredito:originacionCredito:LATEST/process/instance/${id}/signal?signal=${signal}&event="${event}"`;
    const headers = {
      Accept: 'application/json'
    };
    request.post(
